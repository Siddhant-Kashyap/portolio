    ...
    <>
      ...
      <div id='nav' className="block md:flex justify-evenly items-center  bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:20px_20px] text-amber-300 font-modimi h-20">
        ...
        <div className="flex justify-evenly items-center ">
          ...
          <span onClick={()=>window.open("https://www.linkedin.com/in/itsmesid/","_blank")}  className="mr-4 [&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#0077b5] cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path d="M100.3 448H7.4V148.9h92.9zM53.8 108.1C24.1 108.1 0 83.5 0 53.8a53.8 53.8 0 0 1 107.6 0c0 29.7-24.1 54.3-53.8 54.3zM447.9 448h-92.7V302.4c0-34.7-.7-79.2-48.3-79.2-48.3 0-55.7 37.7-55.7 76.7V448h-92.8V148.9h89.1v40.8h1.3c12.4-23.5 42.7-48.3 87.9-48.3 94 0 111.3 61.9 111.3 142.3V448z" />
            </svg>
          </span>
          <span onClick={()=>window.open("https://drive.google.com/drive/folders/1Lv_FCtwWoHGliIRSDm5nlgFf6jiUmAq5","_blank")} className="mr-4 cursor-pointer">Resume</span>
